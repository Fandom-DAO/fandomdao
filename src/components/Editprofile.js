...
function Editprofile({ open, setOpen, acc }) {
  ...
  // compressIamge function is used to reduce the image size
  ...
  async function compressImage(imageFile) {
    ...
    // try to compress and return the compressed image
    try {
      ...
      // converting the compresedBlob to Image File and returning
      const compressedFile = blobToFile(compressedBlob, "profile.png");
  ...
  // blobToFile is to convert Compressed blob to Image <File>
