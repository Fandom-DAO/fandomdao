  ...
  return (
    <div className='flex flex-col w-full justify-center items-center overflow-hidden mt-8'>
      ...
      <div className='flex justify-evenly gap-x-4  text-left p-8'>
        <div className='bg-gray-900 flex rounded-lg flex-col w-1/4 p-4 border-2 border-bluecolor'>
        ...
        <div className='bg-gray-900 rounded-lg flex flex-col w-1/4 p-4 border-2 border-bluecolor'>
